...
const CARDS: ModalityCard[] = [
  ...
  { id: 'futsal-m',        name: 'Futsal',            gender: 'M',   photo: '/modalities/futsal-masc.png',      achievement: '' },
  ...
  { id: 'volei-f',         name: 'Vôlei',             gender: 'F',   photo: '/modalities/volei-fem.png',        achievement: '' },
  { id: 'volei-praia-m',   name: 'Vôlei de Praia',    gender: 'M',   photo: '/modalities/volei-praia-masc.png', achievement: '3° Lugar Geral — JJPR 2025' },
  { id: 'volei-praia-f',   name: 'Vôlei de Praia',    gender: 'F',   photo: '/modalities/volei-praia-fem.png',  achievement: '' },
  { id: 'handebol-m',      name: 'Handebol',          gender: 'M',   photo: '/modalities/handebol-masc.png',    achievement: '3° Lugar Geral — JJPR 2025' },
  { id: 'handebol-f',      name: 'Handebol',          gender: 'F',   photo: '/modalities/handebol-fem.png',     achievement: '' },
  { id: 'natacao-f',       name: 'Natação',            gender: 'F',   photo: '/modalities/natacao.png',          achievement: '1° Lugar Geral — JJPR 2025', champion: true },
  { id: 'natacao-m',       name: 'Natação',            gender: 'M',   photo: '/modalities/natacao-masc.png',     achievement: '1° Lugar Geral — JJPR 2025', champion: true },
  ...
  { id: 'judo-m',          name: 'Judô',              gender: 'M',   photo: '/modalities/judo-m.png',           achievement: '' },
  { id: 'atletismo-f',     name: 'Atletismo',         gender: 'F',   photo: '/modalities/atletismo-fem.png',    achievement: '3° Lugar Geral — JJPR 2025' },
  { id: 'atletismo-m',     name: 'Atletismo',         gender: 'M',   photo: '/modalities/atletismo-masc.png',   achievement: '' },
  { id: 'tenis-campo-m',   name: 'Tênis de Campo',    gender: 'M',   photo: '/modalities/tenis-campo-masc.png', achievement: '3° Lugar Geral — JJPR 2025' },
  { id: 'tenis-campo-f',   name: 'Tênis de Campo',    gender: 'F',   photo: '/modalities/tenis-campo-fem.png',  achievement: '1° Lugar Geral — JJPR 2025', champion: true },
  { id: 'xadrez',           name: 'Xadrez',            gender: 'M/F', photo: '/modalities/xadrez-misto.png',     achievement: '3° Lugar Geral — JJPR 2025' },
]
